package com.whx.myspringboot.config;
...
public class SwaggerConfig {
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.whx.myspringboot.controller"))
     ...
     * 访问地址：http://localhost:8895/swagger-ui/index.html
     *
     * @return
     */
